...
#api = twitter.Api(consumer_key='UkeFqKRbvax5yVusCS8NJ5KWS', consumer_secret='QImE6JFLXkVSyigKvZnTYc7QsUzoYbyalPhXXpCq92inq8V9tN',
#access_token_key='1340701292-wb9amlBHN98WnFoJKKkKeV6Hb0FpKoO10Ncg2sA', access_token_secret='2ZcE9wJ6HXuafPbtPNv7an9Kldr1MXtfeBsBQvp4JgZjJ')
...
def renderTweetHtml(tweet):
    ...
    #print(datetime.fromtimestamp(tweet.created_at_in_seconds).strftime(date_format))
    context = {
...
#print ('State: ')
#print (message.retweeted)
#print (message)
#print ('---------------------------------------')
#if(not message.retweeted):
#    print ('State: ')
#    print (message.retweeted)
#    print (message)
